...
//    }
//
//    private final JComboBox<Department> groupCombo = new JComboBox<>();
//
//    private final JComboBox<CourseType> moduleCombo = new JComboBox<>();
//
...
//        lblStudentResultTitle.setText((selectedAssignment == null) ? "Course Modules" : selectedAssignment.getName() + " Modules");
//
//        tblStudentResult.clear();
//
////        if (courseModules != null) {
...
//        btnOpenStudents.setText("All students");
...
//        departmentService.getAll().forEach(groupCombo::addItem);
//
